"""HTTP API handler for deleting an evidence record."""
...
PATH_PARAMETER = "id"
ALLOWED_METHODS = "OPTIONS,DELETE"
...
def lambda_handler(event, context):
    ...
    if not isinstance(evidence_id, str) or not evidence_id or request.path != "/evidence/" + evidence_id:
