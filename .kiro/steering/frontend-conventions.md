...
- Read the API origin from `import.meta.env.VITE_API_BASE_URL` and normalize URL joining in one typed API client.
...
- Require a passing TypeScript check, frontend test suite, and Vite production build before deployment.